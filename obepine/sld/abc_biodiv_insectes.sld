    ...
    <sld:UserStyle>
      ...
      <sld:Rule>
          ...
          <ogc:Filter>
            <ogc:And>
              ...
              <ogc:PropertyIsLike wildCard="*" singleChar="." escape="!">
                ...
                <ogc:Literal>*Insectes*</ogc:Literal>
              </ogc:PropertyIsLike>
            </ogc:And>
          </ogc:Filter>
        ...
        <sld:Rule>
          ...
          <sld:Title>Faible (1 à 20 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
        ...
        <sld:Rule>
          ...
          <sld:Title>Moyen (21 à 50 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>nb_sp</ogc:PropertyName>
        ...
        <sld:Rule>
          ...
          <sld:Title>Bon (51 à 200 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>nb_sp</ogc:PropertyName>
        ...
        <sld:Rule>
          ...
          <sld:Title>Très bon (201 à 500 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>nb_sp</ogc:PropertyName>
        ...
        <sld:Rule>
          ...
          <sld:Title>Exceptionnel (+501 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>nb_sp</ogc:PropertyName>
