    ...
    <sld:UserStyle>
      <sld:FeatureTypeStyle>
          ...
          <ogc:Filter>
            <ogc:And>
              ...
              <ogc:PropertyIsLike wildCard="*" singleChar="." escape="!">
                ...
                <ogc:Literal>*Oiseaux*</ogc:Literal>
              </ogc:PropertyIsLike>
            </ogc:And>
          </ogc:Filter>
        ...
        <sld:Rule>
          ...
          <sld:Title>Bon (51 à 100 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>nb_sp</ogc:PropertyName>
        ...
        <sld:Rule>
          ...
          <sld:Title>Très bon (101 à 200 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>nb_sp</ogc:PropertyName>
        ...
        <sld:Rule>
          ...
          <sld:Title>Exceptionnel (+201 espèces)</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
                <ogc:PropertyName>nb_sp</ogc:PropertyName>
